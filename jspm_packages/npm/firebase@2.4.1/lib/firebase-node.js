...
(function(Buffer, process) {
  (function() {
    ...
    ;
    var Kb = n.Promise || nb;
    nb.prototype["catch"] = nb.prototype.fh;
    function A() {
      var a = this;
    ...
    Mg.prototype.open = function(a, b) {
    ...
    function Vg(a) {
      ad.get("redirect_request_id") && Wg(a);
      var b = a.vc.get();
      b && b.token ? (Xg(a, b), a.ef(b.token, function(c, d) {
        Yg(a, c, d, !1, b.token, b);
      }, function(b, d) {
        Zg(a, "resumeSession()", b, d);
      })) : Xg(a, null);
    }
    ...
    function eh(a, b, c, d) {
      ...
      }, 0) : (c.ee.window_features = "menubar=yes,modal=yes,alwaysRaised=yeslocation=yes,resizable=yes,scrollbars=yes,status=yes,height=625,width=625,top=" + ("object" === typeof screen ? .5 * (screen.height - 625) : 0) + ",left=" + ("object" === typeof screen ? .5 * (screen.width - 625) : 0), c.ee.relay_url = Jg(a.G.jc), c.ee.requestWithCredential = u(a.tc, a), dh(a, e, "/auth/" + b, c, d));
    }
    function Wg(a) {
      ...
      if (b) {
        ...
        a.Te = !0;
        Hg();
        dh(a, d, "/auth/session", c, function() {
          this.Te = !1;
        }.bind(a));
      }
    }
    ...
    h.Ue = function(a, b) {
      ...
      this.tc(d, e, function(a, d) {
        !a && d && d.uid && c.ob && c.ob.uid && c.ob.uid === d.uid && ah(c);
        S(b, a);
      });
    };
    h.oe = function(a, b) {
    ...
    function dh(a, b, c, d, e) {
      fh(a, b, c, d, function(b, c) {
        !b && c && c.token && c.uid ? $g(a, c.token, c, d.nd, function(a, b) {
          a ? S(e, a) : S(e, null, b);
    ...
    function fh(a, b, c, d, e) {
      ...
      }, 0) : (b = new (b.shift())(d.ee), d = Eb(d.eb), d.v = "node-" + Cb, d.transport = b.Ub(), d.suppress_status_codes = !0, a = Ig() + "/" + a.G.jc + c, b.open(a, d, function(a, b) {
        if (a)
          S(e, a);
        else if (b && b.error) {
    ...
    var kh,
        lh;
    jh.prototype.open = function(a, b) {
      this.jf = 0;
      this.na = b;
      this.Df = new gh(a);
      this.Bb = !1;
      ...
      sd(function() {
        if (!c.Bb) {
          c.Va = new mh(function(a, b, d, k, m) {
            nh(c, arguments);
            if (c.Va)
              if (c.sb && (clearTimeout(c.sb), c.sb = null), c.Ic = !0, "start" == a)
                c.id = b, c.Sg = d;
              else if ("close" === a)
                b ? (c.Va.Sf = !1, hh(c.Df, b, function() {
                  c.ab();
                })) : c.ab();
              else
    ...
    jh.isAvailable = function() {
      return kh || !lh && "undefined" !== typeof document && null != document.createElement && !("object" === typeof window && window.chrome && window.chrome.extension && !/^chrome/.test(window.location.href)) && !("object" === typeof Windows && "object" === typeof Windows.kh) && !1;
    };
    h = jh.prototype;
    h.Ed = function() {};
    h.cd = function() {
      ...
      if (a.ke && a.Sf && a.Qe.count() < (0 < a.$c.length ? 2 : 1)) {
        ...
        for (var b = a.hd(b),
          ...
          if (1870 >= a.$c[0].lf.length + 30 + c.length) {
            var e = a.$c.shift(),
                c = c + "&seg" + d + "=" + e.Xg + "&ts" + d + "=" + e.gh + "&d" + d + "=" + e.lf;
            d++;
          } else
            break;
        rh(a, b + c, a.se);
    ...
    ;
    var vh = null,
        vh = require('faye-websocket').Client;
    function wh(a, b, c, d) {
      this.qe = a;
      this.f = nd(this.qe);
    ...
    wh.prototype.open = function(a, b) {
      ...
      try {
        this.Ka = new vh(this.ff, [], {headers: {"User-Agent": "Firebase/5/" + Cb + "/" + process.platform + "/Node"}});
      } catch (c) {
      ...
      this.Ka.onmessage = function(a) {
        if (null !== e.Ka)
          if (a = a.data, e.pb += a.length, pc(e.Wa, "bytes_received", a.length), yh(e), null !== e.frames)
            zh(e, a);
          else {
            a: {
    ...
    function Ch(a, b) {
      ...
      b.jh && (c || R("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), d = !0);
      if (d)
        a.fd = [wh];
      else {
        var e = a.fd = [];
            ...
            if ("c" == d) {
              if (d = ud("t", c), "d" in c)
                if (c = c.d, "h" === d) {
                  ...
                  a.Tf = c.s;
                  cd(a.G, f);
                  0 == a.N && (a.K.start(), Jh(a, a.K, d), "5" !== e && R("Protocol version mismatch detected"), c = a.Vf, (c = 1 < c.fd.length ? c.fd[1] : null) && Kh(a, c));
                } else if ("n" === d) {
                  ...
                  "s" === d ? (a.f("Connection shutdown command received. Shutting down..."), a.Oe && (a.Oe(c), a.Oe = null), a.na = null, a.close()) : "r" === d ? (a.f("Reset packet received.  New host: " + c), cd(a.G, c), 1 === a.N ? a.close() : (Mh(a), Gh(a))) : "e" === d ? od("Server Error: " + c) : "o" === d ? (a.f("got pong on primary."), Nh(a), Oh(a)) : od("Unknown control packet command: " + d);
            } else
              "d" == d && a.Jd(c);
          } else if (b === a.F)
            if (d = ud("t", c), c = ud("d", c), "c" == d)
              "t" in c && (c = c.t, "a" === c ? Ph(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.F.close(), a.gd !== a.F && a.bd !== a.F || a.close()) : "o" === c && (a.f("got pong on secondary."), a.Rf--, Ph(a)));
            else if ("d" == d)
              a.Nd.push(c);
            else
    ...
    function Ph(a) {
      ...
      }), a.gd = a.F, Lh(a)) : (a.f("sending ping on secondary."), a.F.send({
        t: "c",
        d: {
          t: "p",
          d: {}
    ...
    function Oh(a) {
      a.Cb || 1 !== a.N || (a.f("sending ping on primary."), Qh(a, {
        t: "c",
        d: {
          t: "p",
          d: {}
    ...
    h.Ne = function(a, b, c) {
      this.qa ? Yh(this, "o", a, b, c) : this.Wc.push({
        oc: a,
        action: "o",
        data: b,
        I: c
    ...
    h.Ff = function(a, b, c) {
      this.qa ? Yh(this, "om", a, b, c) : this.Wc.push({
        oc: a,
        action: "om",
        data: b,
        I: c
    ...
    h.Kd = function(a, b) {
      this.qa ? Yh(this, "oc", a, null, b) : this.Wc.push({
        oc: a,
        action: "oc",
        data: null,
        I: b
    ...
    h.Jd = function(a) {
      if ("r" in a) {
        ...
        "a" in a && (b = a.a, c = a.b, this.f("handleServerMessage", b, c), "d" === b ? this.Ib(c.p, c.d, !1, c.t) : "m" === b ? this.Ib(c.p, c.d, !0, c.t) : "c" === b ? ai(this, c.p, c.q) : "ac" === b ? (a = c.s, b = c.d, c = this.Ca, this.Ca = null, c && c.ld && c.ld(a, b)) : "sd" === b ? this.Xe ? this.Xe(c) : "msg" in c && "undefined" !== typeof console && console.log("FIREBASE: " + c.msg.replace("\n", "\nFIREBASE: ")) : od("Unrecognized action received from server: " + F(b) + "\nAre you using the latest client?"));
      }
    };
    h.Xc = function(a, b) {
    ...
    h.Mg = function(a) {
      a && !this.Qb && this.bb === this.Fd && (this.f("Window became visible.  Reducing delay."), this.bb = 1E3, this.La || Th(this, 0));
      this.Qb = a;
    };
    h.Kg = function(a) {
      a ? (this.f("Browser went online."), this.bb = 1E3, this.La || Th(this, 0)) : (this.f("Browser went offline.  Killing connection."), this.La && this.La.close());
    };
    h.Hf = function() {
      ...
      0 === this.Zc && (this.sa = []);
      this.Ud = {};
      di(this) && (this.Qb ? this.Mc && (3E4 < (new Date).getTime() - this.Mc && (this.bb = 1E3), this.Mc = null) : (this.f("Window isn't visible.  Delaying reconnect."), this.bb = this.Fd, this.Ge = (new Date).getTime()), a = Math.max(0, this.bb - ((new Date).getTime() - this.Ge)), a *= Math.random(), this.f("Trying to reconnect in " + a + "ms"), Th(this, a), this.bb = Math.min(this.Fd, 1.3 * this.bb));
      this.Vc(!1);
    };
    function ci(a) {
      if (di(a)) {
        ...
        var b = u(a.Jd, a),
            ...
            d = u(a.Hf, a),
            e = a.id + ":" + Uh++;
        a.La = new Fh(e, a.G, b, c, d, function(b) {
          R(b + " (" + a.G.toString() + ")");
          a.yf = !0;
        }, a.Db);
      }
    ...
    function bi(a) {
      ...
      for (var b = 0; b < a.sa.length; b++)
        a.sa[b] && $h(a, b);
      for (; a.Wc.length; )
        b = a.Wc.shift(), Yh(a, b.action, b.oc, b.data, b.I);
    }
    function di(a) {
      var b;
      b = gf.wb().mc;
    ...
    h.matches = function(a) {
      return a instanceof ii ? a.Tb && this.Tb ? a.Tb === this.Tb && a.tb === this.tb : !0 : !1;
    };
    h.uf = function() {
      return null !== this.Tb;
    };
    ...
    function si(a, b, c) {
      ...
      if (a.kb.Sd(b)) {
        ...
        return qi(a, new Bf(d.path, e, c));
      }
      return [];
    }
    function ti(a, b, c) {
      c = qf(c);
      return qi(a, new $e(Ef, b, c));
    }
    function ui(a, b, c, d) {
      d = vi(a, d);
      if (null != d) {
    ...
    oi.prototype.Rb = function(a, b) {
      ...
      var f = this.va.get(c);
      f ? (e = e || null != li(f), d = d || f.ib(L)) : (f = new ki, this.va = this.va.set(c, f));
      var g;
    ...
    oi.prototype.lb = function(a, b, c) {
      var d = a.path,
          e = this.va.get(d),
          f = [];
        ...
        if (b && !g && (d = this.va.subtree(d), !d.e()))
          for (var d = Ci(d),
            ...
            var m = d[k],
                l = m.Y,
                m = Di(this, m);
            this.Oc.Ye(Ei(l), Fi(this, l), m.xd, m.I);
          }
        if (!g && 0 < e.length && !c)
          if (b)
            this.Oc.ae(Ei(a), null);
          else {
            var r = this;
            Na(e, function(a) {
              a.wa();
    ...
    function Bi(a, b, c) {
      var d = b.path,
          e = Fi(a, b);
      c = Di(a, c);
      b = a.Oc.Ye(Ei(b), e, c.xd, c.I);
      d = a.va.subtree(d);
      if (e)
        N(null == li(d.value), "If we're adding a query, it shouldn't be shadowed");
      else
        for (e = tf(d, function(a, b, c) {
          if (!a.e() && b && null != li(b))
            return [Xe(li(b))];
          var d = [];
          b && (d = d.concat(Pa(mi(b), function(a) {
            return a.Y;
          })));
          v(c, function(a) {
            d = d.concat(a);
    ...
    function qi(a, b) {
      return Hi(a, b, a.va, null, new Sf(L, a.kb));
    }
    ...
    function Ji(a, b) {
      ...
      this.Cd = new oi({
        Ye: function(a, b, f, g) {
          b = [];
          f = c.Ce.j(a.path);
          f.e() || (b = qi(c.Cd, new yc(Ef, a.path, f)), setTimeout(function() {
            g("ok");
          }, 0));
          return b;
        },
      ...
      Ki(this, "connected", !1);
      this.na = new Tc;
      this.O = new Ug(a, u(this.da.O, this.da), u(this.da.ge, this.da), u(this.Me, this));
      this.rd = 0;
      this.De = null;
      this.M = new oi({
        Ye: function(a, b, f, g) {
    ...
    h.Ib = function(a, b, c, d) {
      ...
      d ? c ? (b = ma(b, function(a) {
        return P(a);
      }), a = yi(this.M, e, b, d)) : (b = P(b), a = ui(this.M, e, b, d)) : c ? (d = ma(b, function(a) {
        return P(a);
      }), a = ti(this.M, e, d)) : (d = P(b), a = qi(this.M, new yc(Ef, e, d)));
      d = e;
    ...
    h.update = function(a, b, c) {
      ...
      if (d)
        dc("update() called with empty data.  Don't do anything."), Pi(c, "ok");
      else {
        var g = this.Id++,
            k = ri(this.M, a, f, g);
        Yb(this.fa, k);
    ...
    function Oi(a) {
      ...
      Uc(Sc(a.na, b), L, function(b, e) {
        c = c.concat(qi(a.M, new yc(Ef, b, e)));
        var f = Qi(a, b);
        Ni(a, f);
      });
      a.na = new Tc;
    ...
    function hi(a, b, c, d) {
      ...
      for (f in c)
        e = !1;
      e ? (dc("onDisconnect().update() called with empty data.  Don't do anything."), Pi(d, "ok")) : a.da.Ff(b.toString(), c, function(e, f) {
        if ("ok" === e)
          for (var m in c) {
            var l = P(c[m]);
            a.na.qc(b.o(m), l);
    ...
    function Yi(a, b, c) {
      if (0 !== b.length) {
        for (var d = [],
          ...
          if (5 === k.status)
            l = !0, r = k.je, e = e.concat(si(a.M, k.Da, !0));
          else if (1 === k.status)
            if (25 <= k.Qf)
              l = !0, r = "maxretry", e = e.concat(si(a.M, k.Da, !0));
            else {
              var x = a.M.Aa(k.path, f) || G;
              k.od = x;
              var J = b[g].update(x.J());
              p(J) ? (fg("transaction failed: Data returned ", J, k.path), m = P(J), "object" === typeof J && null != J && y(J, ".priority") || (m = m.ia(x.C())), x = k.Da, J = Mi(a), J = Vc(m, J), k.pd = m, k.qd = J, k.Da = a.Id++, Ua(f, x), e = e.concat(pi(a.M, k.path, J, k.Da, k.df)), e = e.concat(si(a.M, x, !0))) : (l = !0, r = "nodata", e = e.concat(si(a.M, k.Da, !0)));
            }
          bc(a.fa, c, e);
          e = [];
    ...
    function $i(a, b) {
      ...
      if (null !== c) {
        for (var d = [],
            ...
            f = -1,
            g = 0; g < c.length; g++)
          4 !== c[g].status && (2 === c[g].status ? (N(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].je = "set") : (N(1 === c[g].status, "Unexpected transaction status in abort"), c[g].he(), e = e.concat(si(a.M, c[g].Da, !0)), c[g].I && d.push(u(c[g].I, null, Error("set"), !1, null))));
    ...
    aj.prototype.uc = function() {
      for (var a in this.rc)
        this.rc[a].uc();
    };
    aj.prototype.ve = function() {
      this.$f = !0;
    };
    ba(aj);
    aj.prototype.interrupt = aj.prototype.Ab;
    aj.prototype.resume = aj.prototype.uc;
    function Y(a, b, c, d) {
      this.k = a;
      this.path = b;
      this.n = c;
    ...
    h.Gb = function(a, b, c, d) {
      ...
      if ("value" === a)
        Ri(this.k, this, new ii(b, e.cancel || null, e.Pa || null));
      else {
        var f = {};
        f[a] = b;
        Ri(this.k, this, new ji(f, e.cancel, e.Pa));
      }
      return b;
    };
    h.kc = function(a, b, c) {
    ...
    Rh.prototype.interrupt = Rh.prototype.Ab;
    Z.cg = Fh;
    Z.RealTimeConnection = Z.cg;
    Fh.prototype.sendRequest = Fh.prototype.Ha;
    ...
    X.prototype.O = function(a, b, c) {
      ...
      var d = new A;
      $g(this.k.O, a, {}, {remember: "none"}, B(d, b), c);
      return d.D;
    };
    ...
    X.prototype.ig = function(a, b, c) {
      ...
      var k = [Mg],
          f = yg(f);
      "anonymous" === a || "firebase" === a ? S(g, T("TRANSPORT_UNAVAILABLE")) : (ad.set("redirect_client_options", f.nd), dh(e, k, "/auth/" + a, f, g));
      return d.D;
    };
    ...
    X.prototype.jg = function(a, b, c, d) {
      ...
      var e = new A;
      q(b) ? (og("Firebase.authWithOAuthToken", 2, b), bh(this.k.O, a + "/token", {access_token: b}, d, B(e, c))) : (qg("Firebase.authWithOAuthToken", 2, b, !1), bh(this.k.O, a + "/token", b, d, B(e, c)));
      return e.D;
    };
    ...
    X.prototype.kg = function(a, b, c) {
      ...
      var d = new A;
      bh(this.k.O, "password", a, c, B(d, b));
      return d.D;
    };
